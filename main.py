...
def appwindow():
    ...
    def endpage():
        ...
        Label(gui,font=("ink free",35),bg="#bfbfbf",text="Aditya Majumdar").place(x=500,y=450)
    ...
    gui = Tk()
    gui.title("TRACK EXPENSE")
    title_label = Label(gui, text="EXPENSE TRACKER")
    title_label.pack(fill="x", anchor="center")
    gui.configure(bg='#0066ff')
    gui.geometry("900x700")
    l8=Label(gui,width=60,height=10,font=("century",35),bg="#1ad1ff",text="").place(x=450,y=60)
    ...
    l6=Label(gui,width=60,font=("century",35),bg="#ff9999",fg="#b32d00",text="EXPENSE  TRACKER").place(x=-200,y=0)
    name = "Welcome,  " + profilename + "  "
    l9=Label(gui,width=60,font=("century",30),bg="#9999ff",fg="black",text=name).place(x=-275,y=60)
    ltime=Label(gui,font=("century",30),bg="#9999ff",fg="black")
    ltime.place(x=470,y=61)
    def digitalclock():
        text_input = time.strftime("  Date - %d-%m-%Y   %H:%M:%S           ")
        ltime.config(text=text_input)
...
l5=Label(root,font=("comic sans ms",17),bg="#751aff",text="Confirm password").place(x=580,y=342)
...
Label(root,width=60,font=("jokerman",35),bg="#ff9999",fg="#cc2900",text="EXPENSE  TRACKER").place(x=-200,y=0)
Label(root,font=("Ink Free",27),bg="#33cccc",fg="#0000ff",text="ADITYA MAJUMDAR").place(x=720,y=590)
b3=Button(root,text="Exit Window",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="red",width=10,command=root.destroy).place(x=410,y=620)
